...
> {
  ...
  public render() {
    const { columns, isCompactMode, items, selectionDetails, isModalSelection, announcedMessage } =
      this.state;
      ...
      <div>
        <div className={classNames.controlWrapper}>
          ...
          <Toggle
            ...
            styles={controlStyles}
          />
          <TextField label="Filter by name:" onChange={() => {
            console.log("changed")}} styles={controlStyles} />
